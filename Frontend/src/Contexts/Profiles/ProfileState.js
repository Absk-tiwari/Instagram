...
const ProfileState = (props) => {
    let navigator = useNavigate()
     const getChats = async(me)=>{
        let res = await fetch('http://https://instagram-api-one.vercel.app//api/messages',{
            method:'POST',
            headers:headers(),
        ...
        let users =await fetch('http://https://instagram-api-one.vercel.app//api/profile/users',{
            method:'POST',
            headers:headers(),
   ...
   const updateProfile = async(formData, image) => {
        ...
        fetch('http://https://instagram-api-one.vercel.app//api/profile/update',{
            method:'POST',
            headers:headers(),
        ...
        let res = await fetch('http://https://instagram-api-one.vercel.app//api/messages/of',{
            method:'POST',
            headers:headers(),
    ...
    const searchUser = async (param)=>{
        try{
            let resp = await fetch('http://https://instagram-api-one.vercel.app//api/profile/search',{
                method:'POST',
                headers:headers(),
    ...
    const updateChat = async(me,username) => {
        let resp = await fetch('http://https://instagram-api-one.vercel.app//api/messages/update',{
            method:'POST',
            headers:headers(),
