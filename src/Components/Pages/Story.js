...
const Story = () => {
    ...
    useEffect(()=>{
        ...
        document.getElementById('progres-bar').children[0].classList.add('active');
    ...
    return ( 
     <div id='storyviewer' >
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-arrow-right-circle text-white" style={{position:'absolute',left:'68%',top:'45%',zIndex:'9999999', cursor:'pointer'}} viewBox="0 0 16 16" data-type='right' onClick={change}>
