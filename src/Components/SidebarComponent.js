...
function SidebarComponent() {
  ...
  const refer = (e) => {
    if(e.target.dataset.refer!=='/search') document.querySelector('.close').click();
    let elem = e.target; 
  ...
  return (
    <div className="custom-sidebar">
      <div className="custom-logo">
        <svg aria-label="Instagram" fill="currentColor" height="39" role="img" viewBox="32 4 113 32" width="103" >
      ...
      <div className="custom-sidebarList">
        {SidebarData.map((val, key) => {
          return (
            <div className={`custom-row ${ location.pathname === val.link && "active" }`}
              key={key} onClick={refer} data-refer={val.link} >
          ...
          <Modal isOpen={open} dimens={{ height: 250, width: 360 }}  onClose={toggleModal} >
            <>
              ...
              <li style={lstyle} className="text-center mt-5 mb-4" >
                <Link className="text-primary text-decoration-none fs-4">Logout</Link>
              </li>
              <li style={lstyle}>
      ...
      <div
        ...
        <div className="offcanvas-header">
          ...
          <button type="button" className="btn-close d-none close" data-bs-dismiss="offcanvas"/>
        </div>
        <div className="offcanvas-body">
          <div className="row"> 
