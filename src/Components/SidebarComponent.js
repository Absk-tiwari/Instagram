      ...
      <div className="custom-sidebar">
        ...
        >
          <div className="offcanvas-header">
            ...
            <button
              type="button"
              className="btn-close d-none close"
          ...
          <div className="offcanvas-body">
            ...
            <div className="row">
              <div className="mt-2 d-flex list-item">
                ...
                {search.length !== 0 && (
                  <p
                    className="text-primary offset-md-8"
              ...
              <div className="mt-2">
                {search &&
                  search.map((item, key) => {
                    return (
                      <li key={key} className="nav-link mx-3 mt-3 d-flex lh-1">
                        <p className="col-md-10">{item}</p>
                        <i
                          className="fa fa-close"
                          onClick={() => removeItem(search.indexOf(item))}
                        ></i>
                      </li>
                    );
                  })}
